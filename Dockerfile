...
# Install Android SDK
RUN wget https://dl.google.com/android/android-sdk_r28.0.3-linux.tgz
RUN tar -xvzf android-sdk_r28.0.3-linux.tgz
RUN mv android-sdk-linux /usr/local/android-sdk
RUN rm android-sdk_r28.0.3-linux.tgz

ENV ANDROID_COMPONENTS platform-tools,android-28,build-tools-28.0.3,build-tools-28.0.3
